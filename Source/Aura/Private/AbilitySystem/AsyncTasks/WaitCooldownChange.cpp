...
void UWaitCooldownChange::OnActiveEffectAdded(UAbilitySystemComponent* AbilitySystemComponent,
	const FGameplayEffectSpec& AppliedEffect, FActiveGameplayEffectHandle EffectHandle)
{
	FGameplayTagContainer AssetTags;
	AppliedEffect.GetAllAssetTags(AssetTags);
	
	FGameplayTagContainer GrantedTags;
	AppliedEffect.GetAllGrantedTags(GrantedTags);
